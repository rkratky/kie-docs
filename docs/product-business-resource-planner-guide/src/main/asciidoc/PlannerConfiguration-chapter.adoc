...
Ask yourself: _What class changes during planning?___Which class has variables that I want the `Solver` to change for me?__ That class is a planning entity.
