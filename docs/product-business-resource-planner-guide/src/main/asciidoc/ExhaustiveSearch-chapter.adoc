...
image::ExhaustiveSearch/bruteForceNQueens04.png[align="center"]
...
image::ExhaustiveSearch/depthFirstBranchAndBoundNQueens04.png[align="center"]
...
image::ExhaustiveSearch/exhaustiveSearchScalabilityNQueens.png[align="center"]

In most use cases, such as Cloud Balancing, the wall appears out of thin air:

image::ExhaustiveSearch/exhaustiveSearchScalabilityCloudBalance.png[align="center"]
