...
[NOTE]
====
The location of the `.niogit` directory may be different based on your configuration. See <<org_uberfire_nio_git_dir, the `org.uberfire.nio.git.dir` system property>>.
====
